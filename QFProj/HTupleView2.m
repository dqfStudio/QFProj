...
@interface HTupleView2 () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic) NSMutableSet *allReuseCells;
@end

@implementation HTupleView2
...
- (id)initWithFrame:(CGRect)frame scrollDirection:(HTupleView2ScrollDirection)direction {
    ...
    if (direction == HTupleView2ScrollDirectionHorizontal) {
