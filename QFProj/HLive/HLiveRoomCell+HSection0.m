...
@interface HLiveRoomTopBarView : UIView <HTupleViewDelegate>
@property (nonatomic) HTupleView *tupleView;
@end

@implementation HLiveRoomTopBarView
...
- (void)tupleExa0_tupleItem:(HTupleItem)itemBlock atIndexPath:(NSIndexPath *)indexPath {
    ...
    HLiveRoomTopBarView *topBarView = [cell viewWithTag:123456];
    if (!topBarView) {
        topBarView = [[HLiveRoomTopBarView alloc] initWithFrame:cell.bounds];
        [cell addSubview:topBarView];
    }
}
@end
