...
#import "HSendVideoVC+HStatus6.h"

@implementation HSendVideoVC (HStatus6)

- (NSInteger)tuple5_numberOfItemsInSection:(NSInteger)section {
    return 8;
}
- (CGSize)tuple5_sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
...
- (void)tuple5_tupleItem:(HTupleItem)itemBlock atIndexPath:(NSIndexPath *)indexPath {
    switch (indexPath.row) {
        case 0: {
