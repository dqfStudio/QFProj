...
#import "HSendVideoVC+HStatus3.h"

@implementation HSendVideoVC (HStatus3)

- (NSInteger)tuple2_numberOfItemsInSection:(NSInteger)section {
    return 8;
}
- (CGSize)tuple2_sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
...
- (void)tuple2_tupleItem:(HTupleItem)itemBlock atIndexPath:(NSIndexPath *)indexPath {
    switch (indexPath.row) {
        case 0: {
        ...
        case 2: {
            ...
            [cell.label setText:@"暂时无法接通，请稍后尝试..."];
        ...
        case 6: {
            ...
            CGRect frame1 = CGRectMake(bounds.size.width/2-KButtonHeight2/2, 0, KButtonHeight2, KButtonHeight2);
            [cell.buttonView setFrame:frame1];
            [cell.buttonView setImageWithName:@"mdeia-button"];
            [cell.buttonView setPressed:^(id sender, id data) {
            ...
            CGRect frame2 = CGRectMake(bounds.size.width/2-KButtonHeight2/2, KButtonHeight2, KButtonHeight2, 25);
            [cell.label setFrame:frame2];
            [cell.label setText:@"挂断"];
            [cell.label setTextColor:UIColor.whiteColor];
            [cell.label setFont:[UIFont systemFontOfSize:12]];
            [cell.label setTextAlignment:NSTextAlignmentCenter];
        }
