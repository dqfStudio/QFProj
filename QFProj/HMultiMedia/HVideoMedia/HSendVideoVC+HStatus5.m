...
#import "HSendVideoVC+HStatus5.h"

@implementation HSendVideoVC (HStatus5)

- (NSInteger)tuple4_numberOfItemsInSection:(NSInteger)section {
    return 8;
}
- (CGSize)tuple4_sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
...
- (void)tuple4_tupleItem:(HTupleItem)itemBlock atIndexPath:(NSIndexPath *)indexPath {
    switch (indexPath.row) {
        case 0: {
