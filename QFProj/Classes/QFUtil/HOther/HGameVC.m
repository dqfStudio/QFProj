...
//        [self.bridge registerHandler:@"backExitApp" handler:^(id data, WVJBResponseCallback responseCallback) {
//            NSLog(@"");
//        }];
//    }
//}
...
//    if ([urlStr containsString:@"no_return"] || [urlStr isEqualToString:@"https://initiate.qfconnect.com/MobileWebGames/game/mgs/www.88898.com"]) {
