...
@class HAnimatedImage;
@protocol HAnimatedImageViewDebugDelegate;
...
//
@interface HAnimatedImageView : UIImageView
...
@property (nonatomic, strong) HAnimatedImage *animatedImage;
