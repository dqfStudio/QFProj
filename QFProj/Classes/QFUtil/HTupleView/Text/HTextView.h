...
/**
 The HTextViewDelegate protocol defines a set of optional methods you can use
 to receive editing-related messages for HTextView objects.
 ...
 */
@protocol HTextViewDelegate <NSObject, UIScrollViewDelegate>
@optional
- (BOOL)textViewShouldBeginEditing:(HTextView *)textView;
- (BOOL)textViewShouldEndEditing:(HTextView *)textView;
- (void)textViewDidBeginEditing:(HTextView *)textView;
- (void)textViewDidEndEditing:(HTextView *)textView;
- (BOOL)textView:(HTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(HTextView *)textView;
- (void)textViewDidChangeSelection:(HTextView *)textView;

- (BOOL)textView:(HTextView *)textView shouldTapHighlight:(HTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(HTextView *)textView didTapHighlight:(HTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(HTextView *)textView shouldLongPressHighlight:(HTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(HTextView *)textView didLongPressHighlight:(HTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
...
/**
 The HTextView class implements the behavior for a scrollable, multiline text region.
 ...
 * It allows to set an attributed text as placeholder.
 ...
 See NSAttributedString+HText.h for more convenience methods to set the attributes.
 See HTextAttribute.h and HTextLayout.h for more information.
 */
@interface HTextView : UIScrollView <UITextInput>
...
@property (nullable, nonatomic, weak) id<HTextViewDelegate> delegate;
...
/**
 The text vertical aligmnent in container. Default is HTextVerticalAlignmentTop.
 */
...
/**
 ...
 @discussion It only support the attributes declared in CoreText and HTextAttribute.
 See `NSAttributedString+HText` for more convenience methods to set the attributes.
 */
...
/**
 ...
 See `HTextParser` protocol for more information.
 */
 ...
 */
@property (nullable, nonatomic, strong, readonly) HTextLayout *textLayout;
...
/**
 ...
 See `HTextLinePositionModifier` protocol for more information.
 */
...
/**
 ...
 The default value is [HTextDebugOption sharedDebugOption].
 */
...
@property (nonatomic) IBInspectable HTextVerticalAlignment textVerticalAlignment;
...
UIKIT_EXTERN NSString *const HTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const HTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const HTextViewTextDidEndEditingNotification;
