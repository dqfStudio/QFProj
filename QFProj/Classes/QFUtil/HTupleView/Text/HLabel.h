...
/**
 The HLabel class implements a read-only text view.
 ...
 */
@interface HLabel : UIView <NSCoding>
...
/**
 The text vertical aligmnent in container. Default is HTextVerticalAlignmentCenter.
 */
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) HTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) HTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) HTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) HTextAction highlightLongPressAction;
...
/*
 ...
 3. If you want to get the highest performance, you should do text layout with
    `HTextLayout` class in background thread. Here's an example:
    
    HLabel *label = [HLabel new];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        text.h_font = [UIFont systemFontOfSize:16];
        text.h_color = [UIColor grayColor];
        [text h_setColor:[UIColor redColor] range:NSMakeRange(0, 4)];
 
        // Create text container
        HTextContainer *container = [HTextContainer new];
        container.size = CGSizeMake(100, CGFLOAT_MAX);
        container.maximumNumberOfRows = 0;
        
        // Generate a text layout.
        HTextLayout *layout = [HTextLayout layoutWithContainer:container text:text];
