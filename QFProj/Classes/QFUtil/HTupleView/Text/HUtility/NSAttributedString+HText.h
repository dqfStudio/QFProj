...
/**
 ...
 All properties defined in UIKit, CoreText and HText are included.
 */
@interface NSAttributedString (HText)

/**
 Archive the string to data.
 @return Returns nil if an error occurs.
 */
- (nullable NSData *)h_archiveToData;
...
/**
 ...
 @return Returns nil if an error occurs.
 */
+ (nullable instancetype)h_unarchiveFromData:(NSData *)data;
 ...
 */
@property (nullable, nonatomic, copy, readonly) NSDictionary<NSString *, id> *h_attributes;
 ...
 */
- (nullable NSDictionary<NSString *, id> *)h_attributesAtIndex:(NSUInteger)index;
 ...
 */
- (nullable id)h_attribute:(NSString *)attributeName atIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIFont *h_font;
- (nullable UIFont *)h_fontAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *h_kern;
- (nullable NSNumber *)h_kernAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *h_color;
- (nullable UIColor *)h_colorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *h_backgroundColor;
- (nullable UIColor *)h_backgroundColorAtIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *h_strokeWidth;
- (nullable NSNumber *)h_strokeWidthAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *h_strokeColor;
- (nullable UIColor *)h_strokeColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) NSShadow *h_shadow;
- (nullable NSShadow *)h_shadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readonly) NSUnderlineStyle h_strikethroughStyle;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *h_strikethroughColor;
- (nullable UIColor *)h_strikethroughColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0
 */
@property (nonatomic, readonly) NSUnderlineStyle h_underlineStyle;
 ...
 */
@property (nullable, nonatomic, strong, readonly) UIColor *h_underlineColor;
- (nullable UIColor *)h_underlineColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *h_ligature;
- (nullable NSNumber *)h_ligatureAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSString *h_textEffect;
- (nullable NSString *)h_textEffectAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *h_obliqueness;
- (nullable NSNumber *)h_obliquenessAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *h_expansion;
- (nullable NSNumber *)h_expansionAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *h_baselineOffset;
- (nullable NSNumber *)h_baselineOffsetAtIndex:(NSUInteger)index;
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:4.3  HText:6.0
 */
@property (nonatomic, readonly) BOOL h_verticalGlyphForm;
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:7.0  HText:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSString *h_language;
- (nullable NSString *)h_languageAtIndex:(NSUInteger)index;
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:6.0  UIKit:7.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) NSArray<NSNumber *> *h_writingDirection;
- (nullable NSArray<NSNumber *> *)h_writingDirectionAtIndex:(NSUInteger)index;
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) NSParagraphStyle *h_paragraphStyle;
- (nullable NSParagraphStyle *)h_paragraphStyleAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) NSTextAlignment h_alignment;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) NSLineBreakMode h_lineBreakMode;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) CGFloat h_lineSpacing;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) CGFloat h_paragraphSpacing;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) CGFloat h_paragraphSpacingBefore;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) CGFloat h_firstLineHeadIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) CGFloat h_headIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) CGFloat h_tailIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) CGFloat h_minimumLineHeight;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) CGFloat h_maximumLineHeight;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) CGFloat h_lineHeightMultiple;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readonly) NSWritingDirection h_baseWritingDirection;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readonly) float h_hyphenationFactor;
...
/**
 ...
 @discussion Default is 0.
 @discussion Get this property returns the first character's attribute.
 @since CoreText:7.0  UIKit:7.0  HText:7.0
 */
@property (nonatomic, readonly) CGFloat h_defaultTabInterval;
...
/**
 ...
 @since CoreText:7.0  UIKit:7.0  HText:7.0
 */
@property (nullable, nonatomic, copy, readonly) NSArray<NSTextTab *> *h_tabStops;
- (nullable NSArray<NSTextTab *> *)h_tabStopsAtIndex:(NSUInteger)index;

#pragma mark - Get HText attribute as property
///=============================================================================
/// @name Get HText attribute as property
///=============================================================================
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) HTextShadow *h_textShadow;
- (nullable HTextShadow *)h_textShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) HTextShadow *h_textInnerShadow;
- (nullable HTextShadow *)h_textInnerShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) HTextDecoration *h_textUnderline;
- (nullable HTextDecoration *)h_textUnderlineAtIndex:(NSUInteger)index;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) HTextDecoration *h_textStrikethrough;
- (nullable HTextDecoration *)h_textStrikethroughAtIndex:(NSUInteger)index;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) HTextBorder *h_textBorder;
- (nullable HTextBorder *)h_textBorderAtIndex:(NSUInteger)index;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readonly) HTextBorder *h_textBackgroundBorder;
- (nullable HTextBorder *)h_textBackgroundBorderAtIndex:(NSUInteger)index;
...
/**
 ...
 @since HText:6.0
 */
@property (nonatomic, readonly) CGAffineTransform h_textGlyphTransform;
- (CGAffineTransform)h_textGlyphTransformAtIndex:(NSUInteger)index;


#pragma mark - Query for HText
///=============================================================================
/// @name Query for HText
///=============================================================================

/**
 Returns the plain text from a range.
 If there's `HTextBackedStringAttributeName` attribute, the backed string will
 replace the attributed string range.
 
 @param range A range in receiver.
 @return The plain text.
 */
- (nullable NSString *)h_plainTextForRange:(NSRange)range;


#pragma mark - Create attachment string for HText
///=============================================================================
/// @name Create attachment string for HText
///=============================================================================
...
/**
 ...
 @since HText:6.0
 */
+ (NSMutableAttributedString *)h_attachmentStringWithContent:(nullable id)content
...
/**
 ...
 @since HText:6.0
 */
+ (nullable NSMutableAttributedString *)h_attachmentStringWithEmojiImage:(UIImage *)image
...
/**
 ...
 If NO, it should be drawn with CoreText or HText.
...
/**
 ...
 All properties defined in UIKit, CoreText and HText are included.
 */
@interface NSMutableAttributedString (HText)
 ...
 */
- (void)h_setAttributes:(nullable NSDictionary<NSString *, id> *)attributes;
- (void)setH_attributes:(nullable NSDictionary<NSString *, id> *)attributes;
 ...
 */
- (void)h_setAttribute:(NSString *)name value:(nullable id)value;
 ...
 */
- (void)h_setAttribute:(NSString *)name value:(nullable id)value range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIFont *h_font;
- (void)h_setFont:(nullable UIFont *)font range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *h_kern;
- (void)h_setKern:(nullable NSNumber *)kern range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *h_color;
- (void)h_setColor:(nullable UIColor *)color range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *h_backgroundColor;
- (void)h_setBackgroundColor:(nullable UIColor *)backgroundColor range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *h_strokeWidth;
- (void)h_setStrokeWidth:(nullable NSNumber *)strokeWidth range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *h_strokeColor;
- (void)h_setStrokeColor:(nullable UIColor *)strokeColor range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSShadow *h_shadow;
- (void)h_setShadow:(nullable NSShadow *)shadow range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readwrite) NSUnderlineStyle h_strikethroughStyle;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *h_strikethroughColor;
- (void)h_setStrikethroughColor:(nullable UIColor *)strikethroughColor range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0
 */
@property (nonatomic, readwrite) NSUnderlineStyle h_underlineStyle;
...
/**
 ...
 @since CoreText:3.2  UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *h_underlineColor;
- (void)h_setUnderlineColor:(nullable UIColor *)underlineColor range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *h_ligature;
- (void)h_setLigature:(nullable NSNumber *)ligature range:(NSRange)range;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSString *h_textEffect;
- (void)h_setTextEffect:(nullable NSString *)textEffect range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *h_obliqueness;
- (void)h_setObliqueness:(nullable NSNumber *)obliqueness range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *h_expansion;
- (void)h_setExpansion:(nullable NSNumber *)expansion range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *h_baselineOffset;
- (void)h_setBaselineOffset:(nullable NSNumber *)baselineOffset range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since CoreText:4.3  HText:6.0
 */
@property (nonatomic, readwrite) BOOL h_verticalGlyphForm;
...
/**
 ...
 @since CoreText:7.0  HText:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSString *h_language;
- (void)h_setLanguage:(nullable NSString *)language range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since CoreText:6.0  UIKit:7.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSArray<NSNumber *> *h_writingDirection;
- (void)h_setWritingDirection:(nullable NSArray<NSNumber *> *)writingDirection range:(NSRange)range;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSParagraphStyle *h_paragraphStyle;
- (void)h_setParagraphStyle:(nullable NSParagraphStyle *)paragraphStyle range:(NSRange)range;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) NSTextAlignment h_alignment;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) NSLineBreakMode h_lineBreakMode;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) CGFloat h_lineSpacing;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) CGFloat h_paragraphSpacing;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) CGFloat h_paragraphSpacingBefore;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) CGFloat h_firstLineHeadIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) CGFloat h_headIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) CGFloat h_tailIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) CGFloat h_minimumLineHeight;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) CGFloat h_maximumLineHeight;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) CGFloat h_lineHeightMultiple;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  HText:6.0
 */
@property (nonatomic, readwrite) NSWritingDirection h_baseWritingDirection;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readwrite) float h_hyphenationFactor;
...
/**
 ...
 @since CoreText:7.0  UIKit:7.0  HText:7.0
 */
@property (nonatomic, readwrite) CGFloat h_defaultTabInterval;
...
/**
 ...
 @since CoreText:7.0  UIKit:7.0  HText:7.0
 */
@property (nullable, nonatomic, copy, readwrite) NSArray<NSTextTab *> *h_tabStops;
- (void)h_setTabStops:(nullable NSArray<NSTextTab *> *)tabStops range:(NSRange)range NS_AVAILABLE_IOS(7_0);

#pragma mark - Set HText attribute as property
///=============================================================================
/// @name Set HText attribute as property
///=============================================================================
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) HTextShadow *h_textShadow;
- (void)h_setTextShadow:(nullable HTextShadow *)textShadow range:(NSRange)range;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) HTextShadow *h_textInnerShadow;
- (void)h_setTextInnerShadow:(nullable HTextShadow *)textInnerShadow range:(NSRange)range;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) HTextDecoration *h_textUnderline;
- (void)h_setTextUnderline:(nullable HTextDecoration *)textUnderline range:(NSRange)range;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) HTextDecoration *h_textStrikethrough;
- (void)h_setTextStrikethrough:(nullable HTextDecoration *)textStrikethrough range:(NSRange)range;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) HTextBorder *h_textBorder;
- (void)h_setTextBorder:(nullable HTextBorder *)textBorder range:(NSRange)range;
...
/**
 ...
 @since HText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) HTextBorder *h_textBackgroundBorder;
- (void)h_setTextBackgroundBorder:(nullable HTextBorder *)textBackgroundBorder range:(NSRange)range;
...
/**
 ...
 @since HText:6.0
 */
@property (nonatomic, readwrite) CGAffineTransform h_textGlyphTransform;
...
- (void)h_setRubyAnnotation:(nullable CTRubyAnnotationRef)ruby range:(NSRange)range NS_AVAILABLE_IOS(8_0);
...
- (void)h_setTextBackedString:(nullable HTextBackedString *)textBackedString range:(NSRange)range;
- (void)h_setTextBinding:(nullable HTextBinding *)textBinding range:(NSRange)range;
- (void)h_setTextAttachment:(nullable HTextAttachment *)textAttachment range:(NSRange)range;
- (void)h_setTextHighlight:(nullable HTextHighlight *)textHighlight range:(NSRange)range;
- (void)h_setTextBlockBorder:(nullable HTextBorder *)textBlockBorder range:(NSRange)range;
- (void)h_setTextRubyAnnotation:(nullable HTextRubyAnnotation *)ruby range:(NSRange)range NS_AVAILABLE_IOS(8_0);
...
- (void)h_setTextHighlightRange:(NSRange)range
                 ...
                 backgroundColor:(nullable UIColor *)backgroundColor
                       ...
                       tapAction:(nullable HTextAction)tapAction
                 longPressAction:(nullable HTextAction)longPressAction;
 ...
 */
+ (NSArray<NSString *> *)h_allDiscontinuousAttributeKeys;
