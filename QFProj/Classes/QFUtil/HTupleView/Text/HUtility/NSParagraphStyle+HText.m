...
@interface NSParagraphStyle_HText : NSObject @end
@implementation NSParagraphStyle_HText @end

@implementation NSParagraphStyle (HText)

+ (NSParagraphStyle *)h_styleWithCTStyle:(CTParagraphStyleRef)CTStyle {
...
- (CTParagraphStyleRef)h_CTStyle CF_RETURNS_RETAINED {
