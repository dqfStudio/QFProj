 ...
 */
@interface NSParagraphStyle (HText)
 ...
 */
+ (nullable NSParagraphStyle *)h_styleWithCTStyle:(CTParagraphStyleRef)CTStyle;

/**
 Creates and returns a CoreText Paragraph Style. (need call CFRelease() after used)
 */
- (nullable CTParagraphStyleRef)h_CTStyle CF_RETURNS_RETAINED;
