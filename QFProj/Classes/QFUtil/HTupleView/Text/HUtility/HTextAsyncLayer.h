...
@class HTextAsyncLayerDisplayTask;

NS_ASSUME_NONNULL_BEGIN

/**
 The HTextAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
 ...
 */
@interface HTextAsyncLayer : CALayer
...
/**
 The HTextAsyncLayer's delegate protocol. The delegate of the HTextAsyncLayer (typically a UIView)
 must implements the method in this protocol.
 */
@protocol HTextAsyncLayerDelegate <NSObject>
@required
...
/**
 A display task used by HTextAsyncLayer to render the contents in background queue.
 */
@interface HTextAsyncLayerDisplayTask : NSObject
