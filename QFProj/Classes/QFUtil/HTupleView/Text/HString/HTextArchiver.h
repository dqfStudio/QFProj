 ...
 */
@interface HTextArchiver : NSKeyedArchiver <NSKeyedArchiverDelegate>
@end
...
/**
 ...
 `HTextArchiver` or `NSKeyedArchiver`.
 */
@interface HTextUnarchiver : NSKeyedUnarchiver <NSKeyedUnarchiverDelegate>
@end
