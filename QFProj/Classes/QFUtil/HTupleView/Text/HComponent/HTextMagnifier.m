...
@interface _HTextMagnifierCaret : HTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _HTextMagnifierCaret
...
- (HTextMagnifierType)type {
    return HTextMagnifierTypeCaret;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathRef strokePath = CGPathCreateWithEllipseInRect(HTextCGRectPixelHalf(rect), NULL);
        ...
        CGContextSaveGState(context); {
            ...
            CGContextSetLineWidth(context, HTextCGFloatFromPixel(1));
...
@interface _HTextMagnifierRanged : HTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation _HTextMagnifierRanged
#define kMultiple 1.2
#define kSize CGSizeMake(141, 60)
#define kPadding HTextCGFloatPixelHalf(6.0)
#define kRadius 6.0
#define kHeight 32.0
#define kArrow 14.0
...
- (HTextMagnifierType)type {
    return HTextMagnifierTypeRanged;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathMoveToPoint(arrowPath, NULL, size.width / 2 - kArrow, HTextCGFloatPixelFloor(kPadding) + kHeight);
        CGPathAddLineToPoint(arrowPath, NULL, size.width / 2 + kArrow, HTextCGFloatPixelFloor(kPadding) + kHeight);
...
@implementation HTextMagnifier

+ (id)magnifierWithType:(HTextMagnifierType)type {
    switch (type) {
        case HTextMagnifierTypeCaret :return [_HTextMagnifierCaret new];
        case HTextMagnifierTypeRanged :return [_HTextMagnifierRanged new];
    }
    return nil;
}
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[HTextMagnifier class]]) {
