...
@implementation HTextContainerView {
...
- (void)setLayout:(HTextLayout *)layout {
...
- (void)setLayout:(HTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_attachmentChanged) {
        ...
        for (HTextAttachment *a in _layout.attachments) {
