...
@protocol HTextLinePositionModifier;
 ...
 */
extern const CGSize HTextContainerMaxSize;

/**
 The HTextContainer class defines a region in which text is laid out.
 HTextLayout class uses one or more HTextContainer objects to generate layouts.
 
 A HTextContainer defines rectangular regions (`size` and `insets`) or
 ...
 Example:
     ...
     └─────────────────────────────┘
 */
@interface HTextContainer : NSObject <NSCoding, NSCopying>
...
/// The constrained size. (if the size is larger than HTextContainerMaxSize, it will be clipped)
...
@property HTextTruncationType truncationType;
...
@property (nullable, copy) id<HTextLinePositionModifier> linePositionModifier;
@end


/**
 The HTextLinePositionModifier protocol declares the required method to modify
 the line position in text layout progress. See `HTextLinePositionSimpleModifier` for example.
 */
@protocol HTextLinePositionModifier <NSObject, NSCopying>
@required
/**
 This method will called before layout is completed. The method should be thread-safe.
 @param lines     An array of HTextLine.
 @param text      The full text.
 @param container The layout container.
 */
- (void)modifyLines:(NSArray<HTextLine *> *)lines fromText:(NSAttributedString *)text inContainer:(HTextContainer *)container;
@end


/**
 A simple implementation of `HTextLinePositionModifier`. It can fix each line's position
 to a specified value, lets each line of height be the same.
 */
@interface HTextLinePositionSimpleModifier : NSObject <HTextLinePositionModifier>
...
/**
 HTextLayout class is a readonly class stores text layout result.
 ...
 example: (layout with a circle exclusion path)
     ...
     └──────────────────────────┘
 */
@interface HTextLayout : NSObject <NSCoding>
...
*/
+ (nullable HTextLayout *)layoutWithContainerSize:(CGSize)size text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable HTextLayout *)layoutWithContainer:(HTextContainer *)container text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable HTextLayout *)layoutWithContainer:(HTextContainer *)container text:(NSAttributedString *)text range:(NSRange)range;

/**
 Generate layouts with the given containers and text.
 
 @param containers An array of HTextContainer object (if nil, returns nil).
 @param text       The text (if nil, returns nil).
 @return An array of HTextLayout object (the count is same as containers),
    or nil when an error occurs.
 */
+ (nullable NSArray<HTextLayout *> *)layoutWithContainers:(NSArray<HTextContainer *> *)containers
...
///< The text container
@property (nonatomic, strong, readonly) HTextContainer *container;
///< The full text
...
///< Array of `HTextLine`, no truncated
@property (nonatomic, strong, readonly) NSArray<HTextLine *> *lines;
///< HTextLine with truncated token, or nil
@property (nullable, nonatomic, strong, readonly) HTextLine *truncatedLine;
///< Array of `HTextAttachment`
@property (nullable, nonatomic, strong, readonly) NSArray<HTextAttachment *> *attachments;
 ...
 */
- (nullable HTextPosition *)closestPositionToPoint:(CGPoint)point;
...
/**
 ...
 @return A text position, or nil if not found.
 */
- (nullable HTextPosition *)positionForPoint:(CGPoint)point
 ...
 */
- (nullable HTextRange *)textRangeAtPoint:(CGPoint)point;
...
/**
 ...
 at point. Or nil if not found.
 */
- (nullable HTextRange *)closestTextRangeAtPoint:(CGPoint)point;
 ...
 */
- (nullable HTextRange *)textRangeByExtendingPosition:(HTextPosition *)position;
...
/**
 ...
 @return An array of `HTextSelectionRect` objects that encompass the selection.
 If not found, the array is empty.
 */
- (NSArray<HTextSelectionRect *> *)selectionRectsForRange:(HTextRange *)range;
...
/**
 ...
 If not found, the array is empty.
 */
- (NSArray<HTextSelectionRect *> *)selectionRectsWithoutStartAndEndForRange:(HTextRange *)range;
...
/**
 ...
 @param range An object representing a range in text.
 @return An array of `HTextSelectionRect` objects contains the start and end to
 the selection. If not found, the array is empty.
 */
- (NSArray<HTextSelectionRect *> *)selectionRectsWithOnlyStartAndEndForRange:(HTextRange *)range;
...
- (void)drawInContext:(nullable CGContextRef)context
                ...
                debug:(nullable HTextDebugOption *)debug
