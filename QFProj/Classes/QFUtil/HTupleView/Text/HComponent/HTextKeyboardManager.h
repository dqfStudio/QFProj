...
/**
 ...
 Use -[HTextKeyboardManager convertRect:toView:] to convert frame to specified view.
 */
typedef struct {
...
}HTextKeyboardTransition;


/**
 The HTextKeyboardObserver protocol defines the method you can use
 to receive system keyboard change information.
 */
@protocol HTextKeyboardObserver <NSObject>
@optional
...
/**
 A HTextKeyboardManager object lets you get the system keyboard information,
 ...
 */
@interface HTextKeyboardManager : NSObject
