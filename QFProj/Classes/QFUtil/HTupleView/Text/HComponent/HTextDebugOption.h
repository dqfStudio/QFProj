...
@class HTextDebugOption;

NS_ASSUME_NONNULL_BEGIN

/**
 The HTextDebugTarget protocol defines the method a debug target should implement.
 A debug target can be add to the global container to receive the shared debug
 option changed notification.
 */
@protocol HTextDebugTarget <NSObject>
 ...
 */
- (void)setDebugOption:(nullable HTextDebugOption *)option;
@end



/**
 The debug option for HText.
 */
@interface HTextDebugOption : NSObject <NSCopying>
 ...
 */
+ (nullable HTextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable HTextDebugOption *)option;
