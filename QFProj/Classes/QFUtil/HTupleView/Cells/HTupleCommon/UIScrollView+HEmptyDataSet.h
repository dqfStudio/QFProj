...
@protocol HEmptyDataSetSource;
@protocol HEmptyDataSetDelegate;

#define HEmptyDataSetDeprecated(instead) DEPRECATED_MSG_ATTRIBUTE(" Use " # instead " instead")

/**
 A drop-in UITableView/UICollectionView superclass category for showing empty datasets whenever the view has no content to display.
 @discussion It will work automatically, by just conforming to HEmptyDataSetSource, and returning the data you want to show.
 */
@interface UIScrollView (HEmptyDataSet)

/** The empty datasets data source. */
@property (nonatomic, weak) IBOutlet id <HEmptyDataSetSource> hEmptyDataSetSource;
/** The empty datasets delegate. */
@property (nonatomic, weak) IBOutlet id <HEmptyDataSetDelegate> hEmptyDataSetDelegate;
/** YES if any empty dataset is visible. */
@property (nonatomic, readonly, getter = isHEmptyDataSetVisible) BOOL hEmptyDataSetVisible;
...
/**
 ...
 @discussion The data source must adopt the HEmptyDataSetSource protocol. The data source is not retained. All data source methods are optional.
 */
@protocol HEmptyDataSetSource <NSObject>
@optional
 ...
 */
- (CGPoint)offsetForEmptyDataSet:(UIScrollView *)scrollView HEmptyDataSetDeprecated(-verticalOffsetForEmptyDataSet:);
...
/**
 ...
 @discussion The delegate can adopt the HEmptyDataSetDelegate protocol. The delegate is not retained. All delegate methods are optional.
 
 @discussion All delegate methods are optional. Use this delegate for receiving action callbacks.
 */
@protocol HEmptyDataSetDelegate <NSObject>
@optional
 ...
 */
- (void)emptyDataSetDidTapView:(UIScrollView *)scrollView HEmptyDataSetDeprecated(-emptyDataSet:didTapView:);
...
/**
 ...
 @param scrollView A scrollView subclass informing the delegate.
 */
- (void)emptyDataSetDidTapButton:(UIScrollView *)scrollView HEmptyDataSetDeprecated(-emptyDataSet:didTapButton:);
