...
#import "HTupleViewApexDetail.h"

@implementation HTupleViewApexDetail
...
@interface HTupleViewApexDetail2 ()
@property (nonatomic) HWebImageView *accessoryView; //右边显示箭头
@end

@implementation HTupleViewApexDetail2
- (void)layoutContentView {
    HLayoutTupleCell(self.cellContentView)
}
- (HWebImageView *)imageView {
