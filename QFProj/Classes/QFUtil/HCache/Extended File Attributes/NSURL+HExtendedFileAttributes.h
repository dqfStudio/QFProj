 ...
 */
@interface NSURL (HExtendedFileAttributes)
 ...
 */
- (id)h_extendedAttributeValueForKey:(NSString *)key error:(int *__nullable)error;
 ...
 */
- (nullable NSData *)h_extendedAttributeDataForKey:(NSString *)key error:(int *__nullable)error options:(int)options;
 ...
 */
- (nullable NSArray *)h_extendedAttributesList:(int *__nullable)error;

/*! Retrieves a list of names of extended attributes.
 @param error Error code is set on failure. You may specify NULL for this parameter. For the list of errors see listxattr(2).
 @param options For the list of available options see listxattr(2).
 */
- (nullable NSArray *)h_extendedAttributesList:(int *__nullable)error options:(int)options;
