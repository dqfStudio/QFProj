...
//        [self methodSwizzleWithOrigSEL:@selector(initWithFormat:) overrideSEL:@selector(formatter_initWithFormat:)];
//        [self classMethodSwizzleWithOrigSEL:@selector(stringWithFormat:) overrideSEL:@selector(formatter_stringWithFormat:)];
//    });
//}
- (instancetype)formatter_initWithFormat:(NSString *)format, ... NS_FORMAT_FUNCTION(1,2) {
    va_list args;
