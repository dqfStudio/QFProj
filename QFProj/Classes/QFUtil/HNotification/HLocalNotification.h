...
@protocol HLocalNotificationDelegate <NSObject>
...
@interface HLocalNotification : NSObject <UIApplicationDelegate, UNUserNotificationCenterDelegate>

/**
 HLocalNotification推送数据回调代理
 */
@property (nonatomic, weak) id<HLocalNotificationDelegate> delegate;
