//
//  UILabel+HAttributeTextTapEvent.m
//  QFProj
//
...
#import "UILabel+HAttributeTextTapEvent.h"
...
@implementation UILabel (HAttributeTextTapEvent)
...
- (void)setIsTapEvent:(BOOL)isTapEvent
{
    objc_setAssociatedObject(self, @selector(isTapEvent), @(isTapEvent), OBJC_ASSOCIATION_ASSIGN);
}
...
- (id<HAttributeTapEventDelegate>)delegate
{
    return objc_getAssociatedObject(self, _cmd);
}
...
- (void)setDelegate:(id<HAttributeTapEventDelegate>)delegate
{
    objc_setAssociatedObject(self, @selector(delegate), delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

#pragma mark - mainFunction
- (void)addAttributeTapEventWithStrings:(NSArray <NSString *> *)strings tapClicked:(void (^) (NSString *string , NSRange range , NSInteger index))tapClick
{
