...
NSString * const ID = @"HCycleScrollViewCell";
...
@implementation HCycleScrollView
...
- (void)initialization {
    _pageControlAliment = HCycleScrollViewPageContolAlimentCenter;
    ...
    _pageControlStyle = HCycleScrollViewPageContolStyleClassic;
...
- (void)setupMainView {
    ...
    [mainView registerClass:[HCollectionViewCell class] forCellWithReuseIdentifier:ID];
...
- (void)setDelegate:(id<HCycleScrollViewDelegate>)delegate {
    _delegate = delegate;
...
- (void)setCurrentPageDotImage:(UIImage *)currentPageDotImage {
    ...
    if (self.pageControlStyle != HCycleScrollViewPageContolStyleAnimated) {
        self.pageControlStyle = HCycleScrollViewPageContolStyleAnimated;
    }
...
- (void)setPageControlStyle:(HCycleScrollViewPageContolStyle)pageControlStyle {
...
- (int)currentIndex {
    if (_mainView.hc_width == 0 || _mainView.hc_height == 0) {
        return 0;
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    HCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
