...
#import "HTableViewApexHoriValue1.h"
...
@interface HTableViewApexHoriValue1 ()
...
- (void)layoutContentView {
    HLayoutTableApex(self.edgeInsetsView)
}
...
@interface HTableViewApexHoriValue2 ()
@property (nonatomic) UIView *containerView;
@property (nonatomic) HWebImageView *accessoryView;
@end
...
@interface HTableViewApexHoriValue3 ()
@property (nonatomic) UIView *containerView;
@property (nonatomic) HWebImageView *accessoryView;
@end
...
@interface HTableViewApexHoriValue4 ()
@property (nonatomic) HWebImageView *accessoryView;
@end
